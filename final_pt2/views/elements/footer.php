   <!-- Le javascript
    ...
    <script src="<?php echo BASE_URL?>views/js/formValidate.js"></script>
    <script src="<?php echo BASE_URL?>views/js/addpostValidate.js"></script>
    <script src="<?php echo BASE_URL?>views/js/ProfForm_validate.js"></script>
