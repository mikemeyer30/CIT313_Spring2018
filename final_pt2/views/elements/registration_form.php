...
<label for="confirm">Confirm Password: <?=REQFIELD?></label>
<input type="password" class="txt" id="confirm" name="confirm" value="<?php echo $password;?>" maxlength="100" required="password" />
