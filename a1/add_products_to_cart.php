...
<?php
  ...
  // added include for fruit_product.class.php so this page had access to its resources
	session_start();
  ...
  // Changed $aryProductsArray to $aryProductArray so variable names are consistent
