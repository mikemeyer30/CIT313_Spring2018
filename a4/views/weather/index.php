...
<div class="container" id="wx">
	...
	<form class="" action="<?php echo BASE_URL?>weather/getresults" method="post">

		<label class =""for="zip">Enter Your Zip Code</label>
		<input class="" name="zip" type="text" id="zip" required="zip" />
		<br>
